...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF81CC29);
  late Color secondary = const Color(0xFF14853D);
  late Color tertiary = const Color(0xFFC22219);
  late Color alternate = const Color(0xFF1573FE);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF52525B);
  late Color primaryBackground = const Color(0xFFE2E2E2);
  late Color secondaryBackground = const Color(0xFF000000);
  late Color accent1 = const Color(0xFFFBCFE8);
  late Color accent2 = const Color(0xFFFED7AA);
  late Color accent3 = const Color(0xFFA1D6FF);
  late Color accent4 = const Color(0xFFBBF7D0);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color navText = Color(0xFFFFFFFF);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color navText = Color(0xFF000000);
}
